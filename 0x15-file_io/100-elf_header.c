 ...
 * @e_ident: A pointer to an array contaning the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
	printf(" ABI Version: %d\n",
		e_ident[El-ABIVERSION]);
}
...
void print_type(unsigned int e_type, unsigned char *e_ident)
{
	if (e-ident[El_DATA] == ELFDATA2MSB)
		e_type >>=8;
	printf( " Type: ");
 ...
 */
void print_entry(usingned long int e_entry, unsigned char *e_ident)
{
...
/**
 * main _ Displays the information contained in the 
